                    ...
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('admin.logbook.logbook.edit', [$country->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i></a>
                                        <button class="btn btn-danger btn-flat" data-toggle="modal" data-target="#modal-delete-confirmation" data-action-target="{{ route('admin.logbook.logbook.destroy', [$country->id]) }}"><i class="fa fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <?php } ?>
